        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <button type="button" class="btn btn-primary waves-effect waves-light" id="primary-popover-content" data-container="body" data-toggle="popover" title="" data-placement="bottom" data-content="<div class='color-code'>
                                                    <div class='row'>
              ...
              " data-original-title="Primary color states">Primary button</button>
                    <button type="button" class="btn btn-success waves-effect waves-light" data-container="body" data-toggle="popover" title="" data-placement="bottom" data-content="<div class='color-code'>
                <div class='row'>
                  <div class='col-sm-6 col-xs-12'>
                    <span class='block'>Normal</span>
                    <span class='block'>
...
</div>" data-original-title="Success color states">Success button</button>
                    <button type="button" class="btn btn-info waves-effect waves-light" data-container="body" data-toggle="popover" title="" data-placement="bottom" data-content="<div class='color-code'>
<div class='row'>
<div class='col-sm-6 col-xs-12'>
<span class='block'>Normal</span>
<span class='block'>
...
</div>" data-original-title="Info color states">Info button</button>
                    <button type="button" class="btn btn-warning waves-effect waves-light" data-container="body" data-toggle="popover" title="" data-placement="bottom" data-content="<div class='color-code'>
<div class='row'>
<div class='col-sm-6 col-xs-12'>
<span class='block'>Normal</span>
<span class='block'>
...
</div>" data-original-title="Warning color states">warning button</button>
                    <button type="button" class="btn btn-danger waves-effect waves-light" data-container="body" data-toggle="popover" title="" data-placement="bottom" data-content="<div class='color-code'>
<div class='row'>
<div class='col-sm-6 col-xs-12'>
<span class='block'>Normal</span>
<span class='block'>
...
</div>" data-original-title="Danger color states">Danger button</button>
                    <button type="button" class="btn btn-inverse waves-effect waves-light" data-container="body" data-toggle="popover" title="" data-placement="bottom" data-content="<div class='color-code'>
<div class='row'>
<div class='col-sm-6 col-xs-12'>
<span class='block'>Normal</span>
<span class='block'>
...
</div>" data-original-title="Inverse color states">Inverse button</button>
                    <button type="button" class="btn btn-disabled waves-effect waves-light" data-container="body" data-toggle="popover" title="" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="Disabled color states">Disabled button</button>
                </div>
            </div>
        </div>
        <div class="col-sm-12">
